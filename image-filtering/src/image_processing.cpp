...
void flip_filter([[maybe_unused]] const FilterParams& params, const cv::Mat &original, cv::Mat &filtered)
{
	int flip_code = params.flip.flip_code; // 0: x-axis, 1: y-axis, -1: both
	cv::flip(original, filtered, flip_code);
}

void sharpening_filter([[maybe_unused]] const FilterParams& params, const cv::Mat &original, cv::Mat &filtered)
{
	// Sharpen image
...
void unsharpening_filter(const FilterParams& params, const cv::Mat &original, cv::Mat &filtered)
{
...
void eroding_filter(const FilterParams& params, const cv::Mat &original, cv::Mat &filtered)
{
...
void dilating_filter(const FilterParams& params, const cv::Mat &original, cv::Mat &filtered)
{
