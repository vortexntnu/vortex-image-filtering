...
static constexpr std::pair<std::string_view, FilterType> kFilterMap[] = {
    ...
    {"gray_world", FilterType::GrayWorld},
    {"shades_of_gray", FilterType::ShadesOfGray},
    {"white_patch", FilterType::WhitePatch},
    {"underwater_compensation", FilterType::UnderwaterRedCompensation},
    {"fixed_gain", FilterType::FixedGain},
    {"clahe", FilterType::Clahe},
